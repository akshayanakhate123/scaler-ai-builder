...
_PDF_GUARDRAIL = (
    ...
    "- TIME/EFFORT: do NOT state a specific weekly time commitment or hours-per-week "
    "figure (e.g. '15-20 hours per week') unless it appears in the grounded facts. If "
    "it isn't grounded, defer: 'the team will walk you through the realistic weekly "
    "commitment on your next call.' (Program durations in months ARE grounded and "
    "fine to state.)\n"
